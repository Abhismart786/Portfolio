...
function showScreenshot(event, projects) {
    ...
    let screenshots = {
        ...
        'reactjs-project-1': './assets/reactjs-screenshot-1.png',
        'reactjs-project-2': './assets/reactjs-screenshot-2.png',
        'web-project-1': './assets/web-screenshot-1.png',
        'web-project-2': './assets/web-screenshot-2.png',
